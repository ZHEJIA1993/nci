...
public class MyGUI extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        vbox.setSpacing(10);  // Setting some space between elements for better appearance

        Scene scene = new Scene(vbox, 400, 500); // Adjusted the height to fit all components
